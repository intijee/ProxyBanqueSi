				...
				<div class="row">
					...
					<div class="col-xs-12" style="height: 525px;">
						...
						<div class="col-xs-10" id="maincontent">
							...
							<div style="width: 310px; margin: auto; display: inline-block; padding: 30px; padding-left: 0px; padding-right: 50px">
								...
								<form:form method="POST" action="soumettreDepotCompte"
									...
									<table>
										...
										<tr>
											<td><form:select cssClass="form-control" path="assoCompte.id_compte">
													<c:forEach var="c" items="${listeComptes}">
														<option value=${c.id_compte}># ${c.numero} ;
															solde : ${c.solde} &euro;</option>
													</c:forEach>
												</form:select></td>
										</tr>
										...
										<tr>
											<td><form:label cssClass="control-label" path="somme">Somme</form:label></td>
											<td><form:input cssClass="form-control" path="somme" /></td>
										</tr>
										<tr>
											<td><br /> <br /></td>
										</tr>
...
<!-- 							<div -->
<!-- 								style="border-left: medium blue solid; height: 350px; display: inline-block;"></div> -->


							<div style="width: 310px; margin: auto; display: inline-block; padding-left: 50px; padding-right: 50px; padding: 30px;">
...
<!-- 							<div -->
<!-- 								style="border-left: medium blue solid; height: 350px; display: inline-block; margin: auto;"></div> -->

							<div style="width: 310px; margin: auto; display: inline-block; padding: 30px; padding-left: 50px; padding-right: 0px; ">
									...
									<table>
										...
										<tr>
											<td colspan="2"><input type="submit"
												value="effectuer le virement" class="form-control"></td>
										</tr>
