				...
				<div class="col-xs-10">
					...
					<ul class="nav nav-pills">
						<li role="presentation"><a
							href="${pageContext.request.contextPath}/j_spring_security_logout">Accueil/Deconnexion</a></li>
						<li role="presentation"><a
							...
							<table class="table table-hover">
								...
								<tbody>
									<c:forEach var="client" items="${clientListe}">
										<tr>
											<td><c:if
													test="${client.humain_0_entreprise_1 == false}">Humain</c:if>
												<c:if test="${client.humain_0_entreprise_1 == true}">Entreprise</c:if></td>
											<td>${client.nom}</td>
											<td>${client.prenom}</td>
