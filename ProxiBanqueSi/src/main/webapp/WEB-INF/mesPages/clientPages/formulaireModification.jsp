...
<header class="row col-sm-12">
 ...
 <h1 class="police_titre">Mise à jour</h1>
        </div>
    </header>
 ...
 <section class="col-sm-9">
           ...
           <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" action="affichFormModifier"
                        method="post">
                             <div class="form-group">
                            <label class="control-label col-sm-5" for="nom">Référence du client:</label>
                            <div class="col-sm-5">
    ...
    <!--pied de page-->
        <footer class="row col-sm-12">
            Accès aux opérations sur comptes bancaires 
        </footer>
    </div> 
